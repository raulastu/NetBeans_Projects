...
public class JPanelLogin2 extends javax.swing.JPanel {    
    ...
    private void initComponents() {
        ...
        setBorder(new javax.swing.border.LineBorder(javax.swing.UIManager.getDefaults().getColor("InternalFrame.inactiveTitleGradient"), 4, true));
        setPreferredSize(new java.awt.Dimension(290, 94));
        jButton2.setText("Logout");

        jButton1.setText("Mi Empresa");

        jLabel1.setText("EmpresaLogeada");
