...
public class JDialogEliminarEmpleado extends javax.swing.JDialog
  {
    public JDialogEliminarEmpleado(java.awt.Frame parent, boolean modal)
      {
        super(parent, modal);
        initComponents();
      }
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("Eliminar Empleado");
        ...
        getContentPane().add(jLabelCorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 170, -1, -1));

        jLabelSucursal.setText("Sucursal");
        getContentPane().add(jLabelSucursal, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 200, -1, -1));
        ...
        getContentPane().add(jTextFieldNombres, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 140, 200, -1));

        jTextFieldCorreo.setEditable(false);
        getContentPane().add(jTextFieldCorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 170, 200, -1));
        ...
        getContentPane().add(jButtonEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 300, 100, -1));
        ...
        getContentPane().add(jButtonSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 300, 100, -1));

        jLabelCodigoDeSindicato.setText("Codigo de Sindicato");
        getContentPane().add(jLabelCodigoDeSindicato, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 230, -1, -1));
...
if(empleadoDAO.eliminarEmpleado(oEmpleado))
...
private void jButtonBuscarAlumnoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarAlumnoActionPerformed
  Empleado oEmpleado=new Empleado(Integer.parseInt(jTextFieldEmpleado_id.getText()));
  EmpleadoDAO oEmpleadoDAO=new EmpleadoDAO();
  oEmpleado=oEmpleadoDAO.buscarEmpleado(oEmpleado);
if(oEmpleadoDAO.buscarEmpleado(oEmpleado)!=null)
    {
        jTextFieldApellidos.setText(oEmpleado.getApellidos());
        jTextFieldNombres.setText(oEmpleado.getNombres());
        jTextFieldCorreo.setText(oEmpleado.getCorreo());
        jTextFieldSucursal.setText(oEmpleado.getSucursal_id()+"");
        jTextFieldCodigoDeSindicato.setText(oEmpleado.getSindicato_id()+"");
        jTextFieldSueldoBasico.setText(oEmpleado.getSueldoBasico()+"");
