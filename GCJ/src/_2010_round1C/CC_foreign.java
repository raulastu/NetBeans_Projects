...
public class CC_foreign {

    private static String fileName = CC_foreign.class.getSimpleName().replaceFirst("_.*", "");
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.err.println(CC_foreign.class.getSimpleName());
