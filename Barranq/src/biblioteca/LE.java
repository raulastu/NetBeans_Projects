...
public class LE {
	...
	/**
	 * Muestra un cuadro de di�logo con el texto formateado.
	 */
	 ...
	 */
	public static char leerChar(Container padre,String mensaje) {
		String cadena;
	try{
		do{
		    cadena=JOptionPane.showInputDialog(padre,mensaje);
		    if(cadena==null)
			mostrarError("Error... no se ha ingresado valor");
   			if(cadena.length()>1)
		mostrarError("Error... debe ingresar s�lo un caracter");
 ...
 */
public static double leerDouble(Container padre,String mensaje) {
	String cadena=leerString(padre,mensaje);
	try {
 ...
 * @param mensaje especifica la solicitud del valor a ingresar.
 */
public static float leerFloat(Container padre,String mensaje) {
	String cadena=leerString(padre,mensaje);
	try {
		return Float.valueOf(cadena).floatValue();
	} catch (NumberFormatException e) {
		mostrarError("Error... debe ingresar un n�mero ");
		return leerFloat(mensaje);
	}
 ...
 * @param mensaje especifica la solicitud del valor a ingresar.
 */
public static int leerInt(Container padre,String mensaje) {
	String cadena=leerString(padre,mensaje);
	try {
		return Integer.parseInt(cadena);
	} catch (NumberFormatException e) {
 ...
 * @param mensaje especifica la solicitud del valor a ingresar.
 */
public static long leerLong(Container padre,String mensaje) {
	String cadena=leerString(padre,mensaje);
	try {
		return Long.parseLong(cadena);
	} catch (NumberFormatException e) {
 ...
 */
public static String leerString(Container padre,String mensaje) {
	String cadena;
	do{
		cadena=JOptionPane.showInputDialog(padre,mensaje);		
		if(cadena==null)
 ...
 */
public static void mostrarAdvertencia(Container padre,String mensaje) {
 ...
 */
public static void mostrarError(Container padre,String mensaje) {
 ...
 */
public static void mostrarInformacion(Container padre,String mensaje) {
	JOptionPane.showMessageDialog(padre,mensaje,"Informaci�n",JOptionPane.INFORMATION_MESSAGE);
}
 ...
 */
public static void mostrarPregunta(Container padre,String mensaje) {
	JOptionPane.showMessageDialog(padre,mensaje,"Pregunta",JOptionPane.QUESTION_MESSAGE);
}
 ...
 */
public static int mostrarPreguntaOpcion2(Container padre,String mensaje) {
	return JOptionPane.showOptionDialog(padre, mensaje, "Pregunta",
 ...
 *	Si se cierra este cuadro de di�logo sin presionar alg�n bot�n, retorna el entero -1.
 */
public static int mostrarPreguntaOpcion3(Container padre,String mensaje) {
	return JOptionPane.showOptionDialog(padre, mensaje, "Pregunta",
 ...
 */
public static void mostrarResultado(Container padre,String mensaje) {
	JOptionPane.showMessageDialog(padre,mensaje,"Resultado",JOptionPane.PLAIN_MESSAGE);
}

public static void mostrarResultadoFormateado(Container padre,String mensaje) {
TextArea objTextArea=new TextArea();
objTextArea.setFont(new Font("Courier",Font.PLAIN,14));
objTextArea.setText(mensaje);
objTextArea.setEditable(false);
JOptionPane.showMessageDialog(padre,objTextArea,"Resultado",JOptionPane.PLAIN_MESSAGE);
}
