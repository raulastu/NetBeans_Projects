...
public class JFrameMenuVendedor extends javax.swing.JFrame {
    
    public JFrameMenuVendedor(String idVend) {
        initComponents();
        jTextField1.setText(idVend);
        this.setTitle("Menu Vendedor - rCkeys;)");                
    }
