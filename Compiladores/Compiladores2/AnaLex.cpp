...
while(!feof(apt)){
 ...
 ban=0;
    // Es numero o letra?
 if(isdigit(c))  edo=MT[edo][28];
 if(isalpha(c))  edo=MT[edo][6];

   // Comparacion del caracter de entrada!!
 switch(c){
  case '+':edo=MT[edo][1];break;
  ...
  case '|':edo=MT[edo][13];break;
  case '&':edo=MT[edo][14];break;
  case '[':edo=MT[edo][15];break;
  case ']':edo=MT[edo][16];break;
  case '(':edo=MT[edo][17];break;
  case ')':edo=MT[edo][18];break;
  case '{':edo=MT[edo][19];break;
  case '}':edo=MT[edo][20];break;
  case '\"':edo=MT[edo][21];break;
  case ';':edo=MT[edo][22];break;
  case ',':edo=MT[edo][23];break;
  case '#':edo=MT[edo][24];break;
  case ' ':edo=MT[edo][25];break;
  case '_':edo=MT[edo][26];break;
  case '\'':edo=MT[edo][27];break;
  case '\n':edo=MT[edo][29];break;
  case ':' :edo=MT[edo][30];break;
 } //fin switch
