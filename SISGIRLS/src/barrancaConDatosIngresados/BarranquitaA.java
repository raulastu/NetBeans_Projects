...
public class BarranquitaA {
    ...
    public BarranquitaA() {
        ...
        ruta = new int[10];
        datos[0] = new String[]{"123", "ERIKA"};
        datos[1] = new String[]{"124", "MILAGROS"};
        datos[2] = new String[]{"125", "MILAGROS"};
        datos[3] = new String[]{"126", "MERCEDES"};
        datos[4] = new String[]{"127", "MILAGROS2"};
        datos[5] = new String[]{"128", "MILAGROS3"};
        datos[6] = new String[]{"129", "MERCEDES3"};
        datos[7] = new String[]{"130", "ERIKA2"};
        datos[8] = new String[]{"131", "MERCEDES2"};
        datos[9] = new String[]{"132", "MERCEDES"};
        ruta[0] = 1;
        ruta[1] = 1;
        ruta[2] = 1;
        ruta[3] = 2;
    ...
    public static void main(String[] args) {
        BarranquitaA bus = new BarranquitaA();
        bus.menu();
    }
    ...
    public void menu() {
        String menu = "Barranquita SRL \n" +
                ...
                "[6] Imprimir boleta\n" +
                "[7] Ver ruta que Gana Mas (AGREGADO POR MI)\n" +
                "[8] Ver ruta que Gana Menos (AGREGADO POR MI TMB :))\n" +
                "[10] Finalizar\n" +
                "------------------------\n" +
                "INGRESE UNA OPCION";
        int opc;
