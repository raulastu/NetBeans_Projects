...
public class BarranquitaB {
    ...
    public BarranquitaB() {
        ...
        ruta = new int[10];
        datos[0] = new String[]{"123", "nobmre a"};
        datos[1] = new String[]{"124", "nobmre b"};
        datos[2] = new String[]{"125", "nobmre c"};
        datos[3] = new String[]{"126", "otro nombre "};
        datos[4] = new String[]{"127", "sjkdsf a"};
        datos[5] = new String[]{"128", "s jsf"};
        datos[6] = new String[]{"129", "ERIAK"};
        datos[7] = new String[]{"130", "MILAGFROS"};
        datos[8] = new String[]{"131", "MERCEDES"};
        datos[9] = new String[]{"132", "OMG"};
        ruta[0] = 1;
        ruta[1] = 1;
        ruta[2] = 1;
        ruta[3] = 2;
    ...
    public static void main(String[] args) {
        BarranquitaB bus = new BarranquitaB();
        bus.menu();
    }
    ...
    public void menu() {
        String menu = "Barranquita SRL \n" +
                ...
                "[6] Imprimir boleta\n" +
                "[7] Ver todos los pasajeros AGRUPADOS por Ruta (AGREGADO POR MI!!!)\n" +
                "[10] Finalizar\n" +
                "------------------------\n" +
                "INGRESE UNA OPCION";
        int opc;
