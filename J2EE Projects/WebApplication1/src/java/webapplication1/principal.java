...
public class principal extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        t_paisDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.t_paisRowSet}"));
        t_personaDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{SessionBean1.t_personaRowSet}"));
    }
    ...
    private CachedRowSetDataProvider t_paisDataProvider = new CachedRowSetDataProvider();

    public CachedRowSetDataProvider getT_paisDataProvider() {
        return t_paisDataProvider;
    }

    public void setT_paisDataProvider(CachedRowSetDataProvider crsdp) {
        this.t_paisDataProvider = crsdp;
    }
    ...
    private CachedRowSetDataProvider t_personaDataProvider = new CachedRowSetDataProvider();

    public CachedRowSetDataProvider getT_personaDataProvider() {
        return t_personaDataProvider;
    }

    public void setT_personaDataProvider(CachedRowSetDataProvider crsdp) {
        this.t_personaDataProvider = crsdp;
    }
    ...
    @Override
    public void destroy() {
        t_paisDataProvider.close();
        t_personaDataProvider.close();
    }
